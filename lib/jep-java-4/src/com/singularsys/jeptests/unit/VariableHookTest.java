...
public class VariableHookTest {
	...
	@Test
	public void set_of_hooks_is_initially_empty() {
		Variable var = vf.createVariable("x");
		Collection<HookKey> keys = var.hookKeys();
		assertTrue(keys.isEmpty());
	}

	@Test
	public void getting_an_unset_HookKey_returns_null() {
		Variable var = vf.createVariable("x");
	...
	@Test
	public void setting_and_getting_a_HookKey_returns_same_value() {
		Variable var = vf.createVariable("x");
	...
	@Test
	public void changing_a_hook_returns_same_value() {
		Variable var = vf.createVariable("x");
	...
	@Test
	public void setting_and_getting_two_hooks_returns_same_value() {
		Variable var = vf.createVariable("x");
		Object data1 = Integer.valueOf(5);
		Object data2 = Integer.valueOf(7);
		var.setHook(key1, data1);
	...
	@Test
	public void setting__and_removing_a_hook_returns_null() {
		Variable var = vf.createVariable("x");
		Object data = Integer.valueOf(5);
		var.setHook(key1, data);
		Object val1 = var.getHook(key1);
	...
	@Test
	public void setting_and_removing_and_setting_same_hook() {
		Variable var = vf.createVariable("x");
		Object data = Integer.valueOf(5);
		Object data2 = Integer.valueOf(7);
	...
	@Test
	public void setting_and_removing_and_setting_different_hook() {
		Variable var = vf.createVariable("x");
		Object data = Integer.valueOf(5);
		Object data2 = Integer.valueOf(7);
	...
	@Test
	public void setting_two_hooks_and_removing_one() {
		Variable var = vf.createVariable("x");
		Object data = Integer.valueOf(5);
		Object data2 = Integer.valueOf(7);
	...
	@Test
	public void setting_the_hooks_and_removing__middle_one() {
		Variable var = vf.createVariable("x");
		Object data = Integer.valueOf(5);
		Object data2 = Integer.valueOf(7);
